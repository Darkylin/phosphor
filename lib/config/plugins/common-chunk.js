...
function makeCommonChunks(context) {
...
function notifyContextChunks(context, commonChunks) {
  context.chunkEntry = commonChunks.map(function (config) {
